...
5) Перевірити існування файла з розширенням txt серед великої кількості файлів в директорії current_dir і, якщо він є, створити масив first_part, де одна стрічка прочитаного файла має бути один елементом.
6) В кожному елементі масиву first_part видалити недруковані символи.
7) Прочитати всі імена файлів в current_dir. Якщо файл має розширення mp4, зберегти його ім'я в масиві mp4_files.
8) Відсортувати елементи mp4_files по порядку від меншого до більшого. Для сортирови використати алгорітм сортування злиттям.
9) Порівняти кількість елементів в масивах first_part і mp4_files.
Якщо вони різні, вивести відповідне повідомлення і завершити виконання стрипта.
10) Перейменувати всі файли з розширенням mp4 в директорії current_dir таким чином, щоб нові файли мали назву "{first_part[i-1]} {старе ім'я}".
END_COMMENT
